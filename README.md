...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-w2ksi24.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-w2ksi24.containers.anotherwebservice.com/
...
```
git clone git@github.com:MKstudio-Tech/container-w2ksi24.git
cd container-w2ksi24
```
...
```
docker attach container-w2ksi24
```
